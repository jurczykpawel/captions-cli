...
export const en: Dict = {
  ...
  premium: {
    ...
    panelBody: 'Get the free styles or buy premium — each unlocks here in the browser and downloads the pack for the CLI. Paste the license token from your email or your Sellf account.',
    needPack: 'Premium style. Get it below, then paste your license token.',
    previewHint: 'Previewing on your video. Unlock to export without a watermark and with the full animation.',
    buyBtn: 'Get premium',
    haveKey: 'Have a token? Paste it:',
    keyPlaceholder: 'License token',
    unlockBtn: 'Unlock',
