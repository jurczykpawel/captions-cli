...
export const en: Dict = {
  ...
  premium: {
    ...
    panelBody: 'Buy once — unlock premium here in the browser and download the pack for the CLI. Bought already? Enter the email you purchased with.',
    needPack: 'Premium style. Buy it, then unlock with your purchase email below.',
    emailPlaceholder: 'Email you purchased with',
    unlockBtn: 'Unlock',
    downloadCli: 'Download pack for CLI (.zip)',
    badEmail: 'Enter a valid email.',
    notFound: 'No purchase found for that email. Check the address, or buy below.',
