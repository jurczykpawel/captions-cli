...
export const pl: Dict = {
  ...
  premium: {
    ...
    panelBody: 'Odbierz darmowe style albo kup premium — każde odblokowuje się tu w przeglądarce i pobiera paczkę do CLI. Wklej token licencyjny z maila lub konta Sellf.',
    needPack: 'Styl premium. Odbierz go poniżej, potem wklej token licencyjny.',
    previewHint: 'Podgląd na Twoim wideo. Odblokuj, żeby eksportować bez znaku wodnego i z pełną animacją.',
    buyBtn: 'Kup premium',
    haveKey: 'Masz token? Wklej go:',
    keyPlaceholder: 'Token licencyjny',
    unlockBtn: 'Odblokuj',
