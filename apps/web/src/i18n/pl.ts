...
export const pl: Dict = {
  ...
  premium: {
    ...
    panelBody: 'Kup raz — odblokuj premium tu w przeglądarce i pobierz paczkę do CLI. Już kupiłeś? Podaj email, którym płaciłeś.',
    needPack: 'Styl premium. Kup go, potem odblokuj mailem z zakupu poniżej.',
    emailPlaceholder: 'Email z zakupu',
    unlockBtn: 'Odblokuj',
    downloadCli: 'Pobierz paczkę do CLI (.zip)',
    badEmail: 'Podaj poprawny email.',
    notFound: 'Nie znaleziono zakupu dla tego maila. Sprawdź adres albo kup poniżej.',
